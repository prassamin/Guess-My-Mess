      ...
      {user && !user.is_anonymous ? (
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6 relative z-10">
          ...
          <button
            onClick={() =>
              createOAuth("google", {
                onStarting() { setGoogleLoading(true); },
                onError(error) { console.error("Error logging in:", error); setGoogleLoading(false); },
