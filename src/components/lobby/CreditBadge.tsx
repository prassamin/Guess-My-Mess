  ...
  return (
    <div className="w-full flex justify-center lg:justify-start lg:absolute lg:bottom-6 lg:left-6 z-20 pointer-events-none px-4 pb-6 lg:pb-0 shrink-0">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-violet-500 to-purple-600 rounded-2xl shadow-[0_4px_0_#5b21b6] group-active:shadow-[0_0px_0_#5b21b6] transition-all" />
